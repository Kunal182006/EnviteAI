# Auth Testing Playbook for InviteAI
...
curl -X GET "https://your-app.com/api/weddings" \
  -H "Authorization: Bearer YOUR_SESSION_TOKEN"

# Test create wedding
curl -X POST "https://your-app.com/api/weddings" \
  -H "Content-Type: application/json" \
  -H "Authorization: Bearer YOUR_SESSION_TOKEN" \
  -d '{"bride_name": "Priya", "groom_name": "Rahul", "wedding_date": "2026-06-15", "religion": "Hindu", "style": "Traditional"}'
```
